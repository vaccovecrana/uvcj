...
static const char* JavaCPP_members[19][20] = {
        ...
        { NULL },
        { NULL },
        { "sizeof", "wKeyFrameRate", "wPFrameRate", "wCompQuality", "wCompWindowSize", "wDelay", "dwMaxVideoFrameSize", "dwMaxPayloadTransferSize", "dwClockFrequency", "bmFramingInfo", "bPreferredVersion", "bMinVersion", "bMaxVersion", "bInterfaceNumber", "bmHint", "bFormatIndex", "bFrameIndex", "dwFrameInterval" },
        { NULL },
        { NULL },
        { "sizeof", "data", "source", "step", "sequence", "width", "data_bytes", "height", "frame_format", "capture_time", "library_owns_data" },
        { NULL },
        { NULL },
        { "sizeof", "parent", "next", "prev", "fourccFormat", "bBitsPerPixel", "bmFlags", "bDefaultFrameIndex", "bAspectRatioX", "bAspectRatioY", "bmInterlaceFlags", "bCopyProtect", "bVariableSize", "frame_descs", "bDescriptorSubtype", "bNumFrameDescriptors", "guidFormat", "bFormatIndex" },
        { NULL },
        { "sizeof", "parent", "next", "prev", "bmCapabilities", "wWidth", "wHeight", "dwMinBitRate", "dwMaxBitRate", "dwMaxVideoFrameBufferSize", "dwDefaultFrameInterval", "dwMinFrameInterval", "dwMaxFrameInterval", "dwFrameIntervalStep", "bFrameIntervalType", "dwBytesPerLine", "intervals", "bDescriptorSubtype", "bFrameIndex" },
        { NULL },
...
static int JavaCPP_offsets[19][20] = {
        ...
        { -1 },
        { -1 },
        { sizeof(::uvc_stream_ctrl_t), offsetof(::uvc_stream_ctrl_t, wKeyFrameRate), offsetof(::uvc_stream_ctrl_t, wPFrameRate), offsetof(::uvc_stream_ctrl_t, wCompQuality), offsetof(::uvc_stream_ctrl_t, wCompWindowSize), offsetof(::uvc_stream_ctrl_t, wDelay), offsetof(::uvc_stream_ctrl_t, dwMaxVideoFrameSize), offsetof(::uvc_stream_ctrl_t, dwMaxPayloadTransferSize), offsetof(::uvc_stream_ctrl_t, dwClockFrequency), offsetof(::uvc_stream_ctrl_t, bmFramingInfo), offsetof(::uvc_stream_ctrl_t, bPreferredVersion), offsetof(::uvc_stream_ctrl_t, bMinVersion), offsetof(::uvc_stream_ctrl_t, bMaxVersion), offsetof(::uvc_stream_ctrl_t, bInterfaceNumber), offsetof(::uvc_stream_ctrl_t, bmHint), offsetof(::uvc_stream_ctrl_t, bFormatIndex), offsetof(::uvc_stream_ctrl_t, bFrameIndex), offsetof(::uvc_stream_ctrl_t, dwFrameInterval) },
        { -1 },
        { -1 },
        { sizeof(::uvc_frame), offsetof(::uvc_frame, data), offsetof(::uvc_frame, source), offsetof(::uvc_frame, step), offsetof(::uvc_frame, sequence), offsetof(::uvc_frame, width), offsetof(::uvc_frame, data_bytes), offsetof(::uvc_frame, height), offsetof(::uvc_frame, frame_format), offsetof(::uvc_frame, capture_time), offsetof(::uvc_frame, library_owns_data) },
        { -1 },
        { -1 },
        { sizeof(::uvc_format_desc), offsetof(::uvc_format_desc, parent), offsetof(::uvc_format_desc, next), offsetof(::uvc_format_desc, prev), offsetof(::uvc_format_desc, fourccFormat), offsetof(::uvc_format_desc, bBitsPerPixel), offsetof(::uvc_format_desc, bmFlags), offsetof(::uvc_format_desc, bDefaultFrameIndex), offsetof(::uvc_format_desc, bAspectRatioX), offsetof(::uvc_format_desc, bAspectRatioY), offsetof(::uvc_format_desc, bmInterlaceFlags), offsetof(::uvc_format_desc, bCopyProtect), offsetof(::uvc_format_desc, bVariableSize), offsetof(::uvc_format_desc, frame_descs), offsetof(::uvc_format_desc, bDescriptorSubtype), offsetof(::uvc_format_desc, bNumFrameDescriptors), offsetof(::uvc_format_desc, guidFormat), offsetof(::uvc_format_desc, bFormatIndex) },
        { -1 },
        { sizeof(::uvc_frame_desc), offsetof(::uvc_frame_desc, parent), offsetof(::uvc_frame_desc, next), offsetof(::uvc_frame_desc, prev), offsetof(::uvc_frame_desc, bmCapabilities), offsetof(::uvc_frame_desc, wWidth), offsetof(::uvc_frame_desc, wHeight), offsetof(::uvc_frame_desc, dwMinBitRate), offsetof(::uvc_frame_desc, dwMaxBitRate), offsetof(::uvc_frame_desc, dwMaxVideoFrameBufferSize), offsetof(::uvc_frame_desc, dwDefaultFrameInterval), offsetof(::uvc_frame_desc, dwMinFrameInterval), offsetof(::uvc_frame_desc, dwMaxFrameInterval), offsetof(::uvc_frame_desc, dwFrameIntervalStep), offsetof(::uvc_frame_desc, bFrameIntervalType), offsetof(::uvc_frame_desc, dwBytesPerLine), offsetof(::uvc_frame_desc, intervals), offsetof(::uvc_frame_desc, bDescriptorSubtype), offsetof(::uvc_frame_desc, bFrameIndex) },
        { -1 },
...
static int JavaCPP_memberOffsetSizes[19] = { 1, 1, 1, 1, 1, 1, 1, 18, 1, 1, 11, 1, 1, 18, 1, 19, 1, 3, 7 };
    ...
    }
{
    ...
    ptr0 = (::uvc_frame*)arg0;
    if (ptr0 != NULL) { 
        obj0 = JavaCPP_createPointer(env, 10);
    }
    if (obj0 != NULL) { 
    ...
    args[1].l = obj1;
    if (obj == NULL) {
        obj = JavaCPP_createPointer(env, 11);
        ...
        for (int i = 0; i < 10; i++) {
            if (this == &JavaCPP_io_vacco_uvc_Uvc_00024UVCFrameCallback_instances[i]) {
                ptr = JavaCPP_io_vacco_uvc_Uvc_00024UVCFrameCallback_allocate_callbacks[i];
                break;
            }
        }
    }
    if (mid == NULL) {
        mid = JavaCPP_getMethodID(env, 11, "call", "(Lio/vacco/uvc/Uvc$UVCFrame;Lorg/bytedeco/javacpp/Pointer;)V");
    }
    if (obj == NULL) {
